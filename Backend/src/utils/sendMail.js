...
//  attachments: [
//       {
//         filename: "example.png", // Replace with your desired filename (if our file is .jpg then it must be .jpg)
//         path: "./public/a.png", // Replace with the actual file path on your server . means root file (no need to be static)
//       },
//     ],
//     html: `<h1>Hello World<h1>`,
//   });
